...
bool Chessboard::Is_Check(bool colour, bool firstround){
	...
	// cout << "positions_threatening_bking.size()" << positions_threatening_bking.size() << endl;
	// cout << "positions_threatening_wking.size()" << positions_threatening_wking.size() << endl;
	...
	// if(positions_threatening_wking.size() >0 && (colour ==true)){
	// 	incheck=true;
	// }
